...
\[
 ...
 =\int_0^{1/n}n\,dx=1.
\]
因此整列不在 \(L^1\) 中趋于零。这里必须核对的定义是“几乎处处”允许删去零测集，以及 \(L^1\) 收敛要求范数趋零。相应修正定理可以加入一个可积控制函数并应用控制收敛定理，或加入一致可积性再配合依测度收敛；这些条件与证明在 Lebesgue 积分各章正式建立。
\end{solution}
