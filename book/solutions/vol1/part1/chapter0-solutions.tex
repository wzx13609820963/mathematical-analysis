...
\begin{chapterguide}
本章解答与正文\chapterref{chap:mathematical-language}的19道习题逐题对应。证明题给出完整逻辑，开放题给出一种可行方案及其所依赖的集合论背景。建议先独立完成习题，再按题号查阅。
\end{chapterguide}
...
\begin{solution}{0.11}
对每个固定 \(n\)，\(\mathbb Z^n\) 是有限个可数无限集的笛卡儿积，因而可数无限。所有有限整数序列组成
\[
