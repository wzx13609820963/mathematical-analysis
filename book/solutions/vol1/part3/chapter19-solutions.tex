...
\section*{A组　定义、判据与典型例}
\addcontentsline{toc}{section}{A组　定义、判据与典型例}
...
\section*{B组　定量连续性与 Cauchy 列}
\addcontentsline{toc}{section}{B组　定量连续性与 Cauchy 列}
...
\section*{C组　延拓、结构与项目}
\addcontentsline{toc}{section}{C组　延拓、结构与项目}
