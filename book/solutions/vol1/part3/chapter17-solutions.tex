...
\section*{A组　连续性的定义与运算}
\addcontentsline{toc}{section}{A组　连续性的定义与运算}
...
\section*{B组　间断与单调函数}
\addcontentsline{toc}{section}{B组　间断与单调函数}
...
\section*{C组　逆映射、结构与项目}
\addcontentsline{toc}{section}{C组　逆映射、结构与项目}
