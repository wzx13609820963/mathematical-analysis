...
需要连续编译两次以生成完整目录。当前主文件载入第一卷前三编3.1版第0—13章及附录A—C；解答册只载入正文各章习题，参考型附录不另设习题。
...
- `chapters/vol1/`：当前已载入的第一卷前三编正文；路径使用3.1版第0—13章编号。
- `solutions.tex`：习题解答册入口，不由教材正文默认载入；
- `solutions/vol1/`：当前第一卷前三编全部正式习题的详细解答；路径与3.1版正文平行。
