...
\begin{description}
 ...
 \item[连续性专题路线] \chapterref{chap:real-number-system}稠密性和可数性 $\to$ \chapterref{chap:subsequences-cluster-points}与\chapterref{chap:limsup-liminf} $\to$ \chapterref{chap:function-limits} $\to$ \chapterref{chap:continuity-discontinuity}至\chapterref{chap:uniform-continuity}。
