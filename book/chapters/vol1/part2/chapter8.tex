...
\begin{enumerate}[label=\textbf{\thechapter.\arabic*.},resume]
 ...
 \]
 \exerciseitem{12.17} 判断 \(\limsup\abs{a_n}=\abs{\limsup a_n}\) 是否总成立，并给出正确关系。
...
\begin{enumerate}[label=\textbf{\thechapter.\arabic*.},resume]
 ...
 \projectexerciseitem{12.26} \ 【前置：本章全部；预计用时：60分钟】把上、下极限写成尾部闭包交集的最大、最小点，并比较“集合表达”“尾部确界表达”“子列表达”三种证明工具。
\end{enumerate}
